...
One table per reporting period, immediately after the takeaway paragraph (before the campaign paragraphs). Columns match the pasted data: `Campaign | Status | Sent | Replies | Positive | OOO` for weekly, `Month | Email Sent | Replies` for monthly.

- Column widths (weekly, DXA, sum 9345): `[3105, 2160, 900, 960, 1110, 1110]`.
